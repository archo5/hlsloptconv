...
source `struct stc4el { float x; float2 yz; float w; }; float4 main():POSITION {
	float vs = 1; stc4el stc; stc = vs; return 0; }`
compile_fail_with_hlsl ``
source `struct stc4el { float x; float2 yz; float w; }; float4 main():POSITION {
	float1 vv1 = 2.0; stc4el stc; stc = vv1; return 0; }`
compile_fail_with_hlsl ``
source `float4 main():POSITION { float4 vv4 = 2.5; float4x4 vm44 = 3.6; vm44 = vv4; return 0; }`
compile_fail_with_hlsl ``
source `struct stc4el { float x; float2 yz; float w; }; float4 main():POSITION {
	float4 vv4 = 2.5; stc4el stc; stc = vv4; return 0; }`
compile_fail_with_hlsl ``
source `struct stc4el { float x; float2 yz; float w; }; float4 main():POSITION {
	float1x1 vm11 = 3.0; stc4el stc; stc = vm11; return 0; }`
compile_fail_with_hlsl ``
